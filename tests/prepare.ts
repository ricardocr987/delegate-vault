...
async function main() {
  ...
  const keypairs = {
    projectOwner: {
      publicKey: publicKeyProjectOwner,
      secretKey: privateKeyProjectOwner,
    },
    user: {
  ...
  console.log("\n3. Project Owner Wallet:");
  console.log("   Address:", publicKeyProjectOwner);
  console.log(
    "   Required SOL:",
    TEST_INITIAL_AMOUNTS.PROJECT_OWNER.SOL,
    "SOL"
  );
  console.log("   Private Key (base58):", privateKeyProjectOwner);
  ...
  console.log(
    "3. Fund the Project Owner wallet with",
    TEST_INITIAL_AMOUNTS.PROJECT_OWNER.SOL,
    "SOL"
  );
  console.log(
